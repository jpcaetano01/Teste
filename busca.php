...
<body>	
	...
	if(empty($_GET['txtBuscar'])) { //txtBuscar se tiver vazio nao tiver mandado parametro nenhum redireciona index.php
	...
	If($consulta->rowCount() == 0) { //se não encontrar esta linha redireciona para erro2.php
