...
<?php
	...
	session_start();
	// se a sessão id estiver vazia ou se a sessao status for diferente de adm entao execute
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-sm-4 col-sm-offset-4">
				...
				<form method="post" action="insprod.php" name="incluiProd" enctype="multipart/form-data"> <!-- enctype usado para inserir imagens-->
				...
				<div class="form-group">
					...
					<input type="number" class="form-control" name="txtpag" required name="txtpag" required id="txtpag">
					...
					<input type="text" class="form-control" name="txtpreco" name="txtpreco" required id="txtpreco">
					...
					<input type="text" class="form-control" name="txtqtde" name="txtqtde" required id="txtqtde">
					...
					<input type="file" accept="image/*" class="form-control" name="txtfoto1" required name="txtfoto1" id="txtfoto1">

					 </div>
					
					<div class="form-group">
				
					<label for="sltlan">Lançamento</label>
