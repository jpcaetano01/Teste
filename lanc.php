...
<body> <!-- não vamos usar dessa forma, será como abaixo
  ...
  <?php //include 'conexao.php' ?> mudou abaixo-->
    ...
    $consulta = $cn->query('select cd_livro,nm_livro,vl_preco,ds_capa,qt_estoque from vw_livro where sg_lancamento = "S"') ; //variavel $cn responsavel pela conexao com banco dados
    ?>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-3"> <!--cria 3 linhas de 4 colunas-->
          ...
          <div><h4><b><?php echo mb_strimwidth($exibe['nm_livro'],0,30,'...'); ?></b></h4></div> <!--h1 trocado pelo h4 . Acrescentado echo mb_strimwidth informando de 0 a 30 caracteres e depois 3 pontinhos-->
          ...
          <a href="detalhes.php?cd=<?php echo $exibe['cd_livro'];?>"> <!--editado aula 38 esta linha-->
