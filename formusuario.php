...
$(document).ready(function(){
    $("#cep").mask("00000-000");
   	//$("#celular").mask(" (00) 00000-0000"); Máscaras seletor"#" aidi"
});
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-sm-4 col-sm-offset-4">
				...
				<form method="post" action="inserirusuario.php" name="logon"> <!-- inserirUsuario.php editado para inserirusuario.php Aula 35-->
