...
<body> <!-- não vamos usar dessa forma, será como abaixo
  ...
  <?php //include 'conexao.php' ?> mudou abaixo-->
    ...
    $consulta = $cn->query("select cd_livro,nm_livro,vl_preco,ds_capa,qt_estoque from vw_livro where ds_categoria = '$cat'") ; //variavel $cn responsavel pela conexao com banco dados
    ?>
...
<!--
  ...
  Aula 24 página index.php salva como lacamento.php

  Aula 25 pagina lanc.php salva como categoria.php
